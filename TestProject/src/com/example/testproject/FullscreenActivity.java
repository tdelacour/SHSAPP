...
public class FullscreenActivity extends Activity {
	...
	private void makeTree(){
	    ...
	    question12.getNextQuestions()[0] = question13;
	    question12.getNextQuestions()[1] = question14;
	...
	private QuestionI makeQuestion7(){
		...
		String feed2 = "How considerate of you! It is good to pause and talk whenever you are not sure when the other person wants, you feel like you're getting mixed signals, or your partner is not responsive.";
	...
	private QuestionI makeQuestion8(){
		String questionS = "It's a good thing that you asked!  They are 100% down for sex and they ask you to use protection...";
		String[] answers = {"A. Sexy sex time! Let's not ruin the mood with the awkward putting-on-the-condom intermission", "B. Ok great! Time to put on a condom!", "C. They probably told that to everyone else that they've had sex with so no need for protection", "D. Naw, protection is optional... it feels better without it anyways..."};
	...
	private QuestionI makeQuestion10(){
		String questionS = "Oh no! Your group is suffering from an erectile dysfunction problem.";
	...
	private QuestionI makeQuestion12(){
		...
		String[] answers = {"A. No thanks, we stopped at Taco Bell on the way home... that CAN'T be a good idea.", "B. Yay! I've always wanted to try anal!", "C. Taco Bell aside, I feel uncomfortable with anal.", "D. I don't want to do it, but I feel pressured so I will. "};
